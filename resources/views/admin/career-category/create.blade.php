...
<div class="min-h-screen bg-[#FDFCFB] flex">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <header class="bg-white border-b border-[#F0EDEA] px-8 py-6 sticky top-0 z-10 flex justify-between items-center bg-opacity-90 backdrop-blur-sm">
            <h1 class="font-radley text-2xl text-[#4A433A]">Add New Category</h1>
            ...
            <div class="bg-white border border-[#F0EDEA] rounded-2xl p-8 shadow-sm">
                <form action="{{ route('career-category.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" required class="w-full bg-[#FDFCFB] border border-[#F0EDEA] px-4 py-3 rounded-xl focus:outline-none focus:border-[#4A433A]" placeholder="e.g. Design">
