    ...
    <section id="journal" class="relative bg-[#F5F1E8] py-[var(--space-6)] md:py-[var(--space-7)] px-[var(--space-2)] md:px-[var(--space-4)]" style="z-index: 90">
        <div class="max-w-[1920px] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[var(--space-2)] md:gap-[var(--space-3)]">
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-1.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Hospitality Manufacturing</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">The Art of Precision in Luxury Hospitality Production</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-bg-2.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Design Excellence</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Crafting bespoke architectural details</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-3.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Material Innovation</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Refined textures for premium interiors</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-4.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Global Standards</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">International quality, local soul</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-5.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Curation</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Bespoke amenity kits for elite travel</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-6.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Wellness</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Soothing scents and organic care</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-7.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Atmosphere</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Elevating guest experiences with aroma</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/about-8.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Hospitality OS&E</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Complete solutions from design to site</h3></div></div>
                <div class="journal-item opacity-0 group cursor-pointer overflow-hidden relative"><div class="aspect-square overflow-hidden"><img src="{{ asset('assets/img/our-jurnal-1.png') }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" /></div><div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500"><span class="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] text-white/70 uppercase mb-2">Legacy</span><h3 class="text-lg md:text-2xl font-radley text-white uppercase leading-tight">Establishing the ARKAN standard</h3></div></div>
            </div>
